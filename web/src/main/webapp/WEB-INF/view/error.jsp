...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">F
                    <h1><c:out value="${requestScope['javax.servlet.error.status_code']}"/> Error Page</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <%--                        <li class="breadcrumb-item"><a href="#">Home</a></li>--%>
                        <li class="breadcrumb-item active"><c:out
                                value="${requestScope['javax.servlet.error.status_code']}"/> Error Page
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <section class="content">
        <div class="error-page">
            <h2 class="headline text-danger"><c:out value="${requestScope['javax.servlet.error.status_code']}"/></h2>

            <div class="error-content">
                <h3><i class="fas fa-exclamation-triangle text-danger"></i>
                    <c:out value="${requestScope['javax.servlet.error.message']}"/></h3>

                <p>
                    이용에 불편을 드려 죄송합니다. <br>
                    서비스에 장애가 발생하였습니다. 빠른 시간안에 조치하도록 하겠습니다. 잠시 후 다시 확인해주세요.
                </p>
