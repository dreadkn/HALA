...
<div id="vue-app" class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">배너 목록</h4>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="row mt-5 mb-3">
                        ...
                        <div class="col-auto">
                            ...
                            <button type="button" class="btn btn-primary " @click="write">배너 등록</button>
                        </div>
                    </div>
                                ...
                                <table id="dataTable" class="table table-sm table-bordered table-striped m-0" >
                                    <thead>
                                        <tr class="text-center text-nowrap">
                                            ...
                                            <th class="align-middle">배너이미지</th>
                                            <th class="align-middle">링크</th>
                                            <th class="align-middle">정렬</th>
...
<script>
    ...
    var vm = new Vue({
        ...
        methods: {
            write: function () {
                location.href = contextPath + "/admin/module/banner/form";
            },
...
<script>
    $(function () {
        dataTable = $('#dataTable').DataTable($.extend(true, dataTableOption, {
            ...
            ajax: {url: '/admin/module/banner/list'},
            order: [[1, "desc"]],
            columns: [
                {
                    data: 'id',
                ...
                {data: 'files', className: 'text-center', render(data){
                    return data != null && data.length > 0 ? '<img class="mw-list-img" src="/files/' + data[0].id + '">' : '';
                    }},
                ...
                {data: null, className: 'text-center', orderable: false, render: function (data, type, row) {
                    var url = contextPath + "/admin/module/banner/" + row.id;
        ...
        $('form').submit(function (event) {
            ...
            dataTable.ajax.url(contextPath + '/admin/module/banner/list' + getSearch()).load();
        });
