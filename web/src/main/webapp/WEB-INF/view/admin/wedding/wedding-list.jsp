...
<div id="vue-app" class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">경조사 목록</h4>
                </div>
                <div class="d-none col-sm-6 d-md-block">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">경조사 관리</li>
                        <li class="breadcrumb-item active">경조사 관리</li>
                        <li class="breadcrumb-item active">경조사 목록</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="row mt-5 mb-3">
                        ...
                        <div class="col-auto">
                            ...
                            <button type="button" class="btn btn-primary " @click="write">경조사 등록</button>
                        </div>
                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        methods: {
            write: function () {
                location.href = contextPath + "/admin/wedding/form";
            },
            addCheck: function (id) {
                ...
                alertConfirm(function(result){
                    if (result)
                    {
                        axios.get(contextPath + "/admin/wedding/check/" + id, {data: {}}).then(function (data) {
                ...
                deleteConfirm(function(result)
                {
                    if (result)
                    {
                        ...
                        self.selected.forEach(function(id){
                            axios.delete("/admin/wedding/" + id, {data: {}}).then(function (res) {
                                if (++chkCnt >= chkLength)
                                {
                                    alertDeleted();
                                    setTimeout(function () {
    ...
    $(function () {
        dataTable = $('#dataTable').DataTable($.extend(true, dataTableOption, {
            ...
            columns: [
                ...
                {data: 'dtype', className: 'text-center', render(data){
                    return data.value;
                    }},
                ...
                {data: null, className: 'text-center', orderable: false, render: function (data, type, row) {
                    var url = contextPath + "/admin/wedding/" + row.id;
        ...
        $('form').submit(function (event) {
            ...
            dataTable.ajax.url(contextPath + '/admin/wedding/list' + getSearch()).load();
        });
