        ...
        <div class="card card-light">
            <div class="card-header card-header-tab py-3">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title text-bold">광고 승인 정보</h3>
                </div>
            </div>
...
<script>
    ...
    var adInfoComponent = {
        ...
        methods: {
            ...
            add : function(){
                var self = this;
                axios.post("/admin/ad", this.ad).then(function (res) {
                    alertRegistered();
                    setTimeout(function(){
            ...
            update : function(){
                var self = this;
                axios.put("/admin/ad/" + this.$parent.id, this.ad).then(function (res) {
                    alertUpdated();
                    setTimeout(function(){
                        self.back();
                    },1500)
            ...
            deletead : function(){
                ...
                deleteConfirm(function(result)
                {
                    if (result)
                    {
                        axios.delete("/admin/ad/" + this.$parent.id, {data: {}}).then(function (res) {
                            alertDeleted();
                            setTimeout(function () {
                                location.href = contextPath + '/admin/ad';
                            }, 1500);
