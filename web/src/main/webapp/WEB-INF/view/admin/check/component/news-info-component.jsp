    ...
    <form>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12">
                        <label class="radio-button-wrap mx-3">
                            <input type="radio" id="isPublicY" name="isPublic" :value="true" v-model="news.isPublic" disabled>
                            <span class="radio-button"></span>
                        </label>
                        <label for="isPublicY" class="mr-5">공개</label>
                        <label class="radio-button-wrap mx-3">
                            <input type="radio" id="isPublicN" name="isPublic" :value="false" v-model="news.isPublic" disabled>
                            <span class="radio-button"></span>
                        </label>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label>제목</label>
                <input type="text" class="form-control" id="title" v-model="news.title"  disabled >
        ...
        <div class="form-row">
            <div class="form-group col-md-8">
                <label>내용</label>
                <textarea name="content" class="w-100" rows="10" v-model="news.content" disabled></textarea>
        ...
        <div class="form-row">
            <div class="form-group col-md-8">
                <label>홈페이지링크</label>
                <input type="text" class="form-control" id="homepageUrl" v-model="news.homepageUrl"  disabled >
                <div id="homepageUrlError" class="invalid-feedback"></div>
            </div>
            <div class="form-group col-md-8">
                <label>유튜브링크</label>
                <input type="text" class="form-control" id="youtubeUrl" v-model="news.youtubeUrl"  disabled >
    ...
    var newsInfoComponent = {
        ...
        methods: {
            fetch: function () {
                ...
                axios.get(contextPath + "/admin/news/detail/" + self.id, {data: {}}).then(function (data) {
                    self.news = data.data;
                }).catch(function (err) {
                });
            }
