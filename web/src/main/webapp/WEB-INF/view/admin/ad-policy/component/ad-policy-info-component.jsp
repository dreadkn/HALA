    ...
    <div class="card card-light">
        <div class="card-header card-header-tab py-3">
            <div class="d-flex justify-content-between">
                <h3 class="card-title text-bold">광고 정책 정보</h3>
            </div>
            <div class="tab-wrap">
        ...
        <div class="card-body" v-show="currentTab == 0">
            <form>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>광고 구분</label>
                        <select class="form-select" v-model="policy.adType">
...
<script>
    ...
    var policyInfoComponent = {
        ...
        watch: {
            policy: function(){
                this.policy.adType = this.policy.adType.code;
        ...
        methods: {
            ...
            add : function(){
                var self = this;
                axios.post("/admin/ad-policy", this.policy).then(function (res) {
                    alertRegistered();
                    setTimeout(function(){
                        location.href = contextPath + '/admin/ad-policy';
                    },1500)
                }).catch(function (err) {
                    displayErrors(err);
                });
            ...
            update : function(){
                var self = this;
                axios.put("/admin/ad-policy/" + this.$parent.id, this.policy).then(function (res) {
                    alertUpdated();
                    setTimeout(function(){
                        self.back();
                    },1500)
            ...
            deletepolicy : function(){
                ...
                deleteConfirm(function(result)
                {
                    if (result)
                    {
                        axios.delete("/admin/ad-policy/" + this.$parent.id, {data: {}}).then(function (res) {
                            alertDeleted();
                            setTimeout(function () {
                                location.href = contextPath + '/admin/ad-policy';
                            }, 1500);
