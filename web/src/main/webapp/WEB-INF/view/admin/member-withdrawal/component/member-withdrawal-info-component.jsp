...
<script type="text/x-template" id="member-withdrawal-info-component">
    <div class="card card-light">
        <div class="card-header card-header-tab py-3">
            <div class="d-flex justify-content-between">
                <h3 class="card-title text-bold">탈퇴 회원 정보</h3>
            </div>
            <div class="tab-wrap">
            ...
            <form>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12 ">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <label class="mw-2"><small class="text-danger">*</small>탈퇴 회원상태</label>
                            </div>
                            <div class="col-12">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        <label>탈퇴일</label>
                        <input type="text" class="form-control" id="withdrawalDate" v-model="member.withdrawalDate"   >
                        <div id="withdrawalDateError" class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-12 ">
...
<script>
    ...
    var memberBlockInfoComponent = {
        template: '#member-withdrawal-info-component',
        mounted: function () {
        ...
        methods: {
            back: function () {
                var backUrl = "/admin/member-withdrawal";
                back(backUrl);
            },
