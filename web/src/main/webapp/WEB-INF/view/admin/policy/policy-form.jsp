...
<jsp:include page="component/policy-info-component.jsp"/>
...
<div id="vue-app" class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">약관 {{isNew ? '등록' : '수정'}}</h4>
                </div>
                <div class="col-sm-6 d-none d-md-block">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">약관 관리</li>
                        <li class="breadcrumb-item active">약관 관리</li>
                        <li class="breadcrumb-item active">약관 {{isNew ? '등록' : '수정'}}</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        methods: {
            fetch: function () {
                var self = this;
                axios.get(contextPath + "/admin/policy/detail/" + self.id, {data: {}}).then(function (data) {
