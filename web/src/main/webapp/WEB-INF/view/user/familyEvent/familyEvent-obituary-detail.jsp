...
<div id="vue-app" class="sub event container">
    <div class="detail-header border-bottom border-2 pb-3">
        ...
        <span class="detail-title d-block fw-bold font-size-30 mb-2">{{obituary.deceased}}씨 {{obituary.deceasedJob ? '(' + obituary.deceasedJob + ')' : ''}}별세</span>
        <div class="d-flex justify-content-between align-items-end">
            <span class="created-date d-flex align-items-center color-border-gray">
                <span class="separator-right d-flex align-items-center">{{dateFormat(obituary.createdDate)}}({{getDay(obituary.createdDate)}}) {{timeFormat(obituary.createdDate)}}</span>{{obituary.createdName}}
            </span>
            <div class="">
    ...
    <div class="detail-contents d-flex flex-column justify-content-md-between flex-md-row">
        <div class="detail-main mt-5 text-center">
            <a :href="obituary.youtubeUrl" class="youtube bg-red font-size-18 d-inline-flex justify-content-center align-items-center py-2 px-5" target="_blank">
                <img src="/resources/img/sub/ico_youtube.png" class="mr-4" />
                유튜브 영상 확인하기
            </a>
            <div class="text-start mt-5 p-2">
                {{obituary.deceased}}씨 {{obituary.deceasedJob ? '(' + obituary.deceasedJob + ')' : ''}}별세
                <br />
            ...
            <div class="detailSwiper swiper position-relative">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" v-for="file in obituary.files">
            ...
            <div class="border-bottom">
                <a :href="obituary.homepageUrl" class="ihalla bg-deep-blue font-size-18 d-inline-flex justify-content-center align-items-center py-2 px-5 my-5" target="_blank">
