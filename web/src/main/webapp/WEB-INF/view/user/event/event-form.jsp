...
<div id="vue-app" class="sub event container">
    ...
    <div class="form-contents">
        <span class="form-title d-block fw-bolder font-size-30">우리지역 행사를 전하고 싶으신가요? 등록하신 콘텐츠는 검수 후 등록됩니다.</span>
    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            fetchByPrice: function () {
                var self = this;
                axios.get("/event/price" , {data: {}}).then(function (data) {
            ...
            submit : function(){
                ...
                var self = this;
                axios.post("/event", this.formData).then(function (res) {
