...
<script type="text/x-template" id="search-news-component">
    <div class="category-wrapper pb-5 border-bottom border-2 border-dark">
        <span class="list-title d-block fw-bold font-size-20">
            <span class="color-deep-blue">뉴스</span> 검색결과
            <span class="font-size-16">({{newsList.length}}건)</span>
        </span>
        <search-article-component :article-list="newsList" detail-url="/news/"></search-article-component>
...
<script>
    var searchNewsComponent = {
        template: '#search-news-component',
        components: {
