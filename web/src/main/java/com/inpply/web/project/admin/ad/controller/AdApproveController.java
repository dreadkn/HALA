...
public class AdApproveController {
    ...
    public DataTable.Returned<AdDto.ListItem> getList(DataTable.Sent sent, Search search) {
        ...
        Page<AdDto.ListItem> page = adQueryRepository.findAllByApprove(sent.getPageable(), search);
    ...
    @ResponseBody
    @ResponseStatus(value = HttpStatus.OK)
    public Long save(@RequestBody @Valid AdDto.Request request) {
    ...
    public Long update(@PathVariable Long id, @RequestBody @Valid AdDto.Request request) {
